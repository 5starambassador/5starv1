            ...
            cols.push({
                ...
                cell: (row: any) => (
                    <div className="flex items-center gap-2">
                        ...
                        {row.parentMobile && (
                            <a 
                                href={`https://wa.me/${row.parentMobile}?text=${encodeURIComponent(`Hello! I'm from ACHARIYA Administration. I'm reaching out regarding your interest/referral for *${row.studentName || 'your child'}* at ${row.campus || 'ACHARIYA'}. I'd love to help with the next steps!`)}`}
                                target="_blank"
