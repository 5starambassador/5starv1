...
export default async function FinancePage({
    ...
    const availableYears = academicYears.map(y => y.year)
    ...
    const totalLiabilities = (liabilitiesRes.success && (liabilitiesRes as any).totalCount) ? (liabilitiesRes as any).totalCount : 0
