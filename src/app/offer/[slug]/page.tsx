...
import { ShieldCheck, ChevronRight, Star, ExternalLink, Smartphone } from 'lucide-react'
import { toast } from 'sonner'
import { captureProgramLead } from '@/app/program-actions'

export default function OfferGatewayPage() {
    return (
        <Suspense fallback={<div className="min-h-screen bg-[#0f172a] text-white flex items-center justify-center">Loading Offer...</div>}>
            <GatewayContent />
        </Suspense>
    )
}
...
function GatewayContent() {
    ...
    const handleProceed = async () => {
        ...
        if (res.success && res.targetUrl) {
            ...
            // Redirect to the SECRET Discount Page
            ...
            <main className="flex-1 flex flex-col items-center justify-center p-6 relative z-10">
                ...
                >
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-white/60 text-sm">You have been invited to access exclusive pricing.</p>
                    </div>
                    ...
                    <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[32px] p-8 shadow-2xl relative overflow-hidden">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-bold text-white/40 uppercase tracking-widest pl-1">Your Name (Optional)</label>
                            ...
                            >
                                {loading ? (
                                    ...
                                    <>
                                        Proceed to Offer <ExternalLink size={16} strokeWidth={2.5} />
                                    </>
                                )}
                            </button>
                        </div>
                    ...
                    <div className="mt-8 text-center opacity-40 flex items-center justify-center gap-2">
                        <ShieldCheck size={12} />
                        <span className="text-[10px] font-bold uppercase tracking-widest">Secure Redirect • Official Achariya URL</span>
                    </div>
                </motion.div>
            </main>
        </div>
