import { Download, FileText, PieChart, BarChart, Users, Building2, ShieldCheck, TrendingUp } from 'lucide-react'
            ...
            {reportGroups.map((group) => (
                <div key={group.id} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm transition-all hover:shadow-md flex flex-col justify-between">
                    ...
                    <button
                        ...
                        className={`w-full py-3 rounded-xl text-sm font-bold flex items-center justify-center gap-2 transition-all bg-gray-50 hover:bg-gray-100 text-gray-900 border border-gray-200`}
                    >
